                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Registrar un usuario</h3>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('add.user.save') }}" method="POST">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input required type="mail" name="mail" class="form-control"  placeholder="" />
